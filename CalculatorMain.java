...
int res;
switch(e) {
case 1 : res=t+Integer.parseInt(t1.getText());
t1.setText("");
t1.setText(Integer.toString(res));
break;
case 2 : res=t-Integer.parseInt(t1.getText());
t1.setText("");
t1.setText(Integer.toString(res));
break;
case 3 : res=t*Integer.parseInt(t1.getText());
t1.setText("");
t1.setText(Integer.toString(res));
break;
case 4 : res=t/Integer.parseInt(t1.getText());
t1.setText("");
t1.setText(Integer.toString(res));
break;
default:
